...
sigma  = 0.1197 # for density of .18
t = 0.0
n_events = 100000
N      = 4 # number of disks
histo_data = []
for event in range(n_events):
    ...
    # for all disks, append their x-positions to histogram data
    for k in range(N):
        histo_data.append(pos[k][0])

# plot histogram of observable=x-position
pylab.hist(histo_data, bins=100, normed=True)
pylab.xlabel('x')
pylab.ylabel('frequency')
pylab.title('Event driven moving disks: x coordinate histogram (density eta=0.18)')
pylab.grid()
